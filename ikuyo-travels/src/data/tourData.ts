...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    itinerary: [
      ...
      {
        day: 2,
        description: 'Venture northwards into lands less frequented by travelers, to Gifu prefecture. Surrounded in lush greenery and lined with gorgeous mountain ranges, immerse yourself in nature and take in the sights of Monet\'s Pond on the way to Shirakawa-go, the world-famous gassho-zukuri thatched straw roof village. Admire the historical exhibits and grand views, then travel to the humbles cities of Furukawa and Takayama to walk through the old townscapes and preserved buildings. Try their delicious ramen, sake, and Hida wagyu beef, then enjoy a luxurious traditional hot spring resort stay in Gero at night.'
      },
      {
        day: 3,
  ...
  {
    id: 'tohoku-autumn-1',
    title: 'Autumn Getaway in Tohoku (1)',
  ...
  {
    id: 'tohoku-autumn-2',
    title: 'Autumn Getaway in Tohoku (2)',
    tagline: 'Pleasant weather and unforgettable fall colours up north',
    duration: '5 Days',
    groupSize: '4-9 pax',
    price: '$1000-$1600/pax',
    imageSeed: 'tohoku-autumn-2',
    itinerary: [
      {
        day: 1,
