    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center text-text-primary mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12 mt-12">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-accent bg-opacity-10 mb-6">
                <HiAdjustments className="text-accent text-3xl" />
              </div>
              <h3 className="font-serif text-xl md:text-2xl font-bold mb-4 text-text-primary">
                Your Trip, Your Pace
              </h3>
            ...
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-accent bg-opacity-10 mb-6">
                <HiLightningBolt className="text-accent text-3xl" />
              </div>
              <h3 className="font-serif text-xl md:text-2xl font-bold mb-4 text-text-primary">
                Avoid the Crowds
              </h3>
            ...
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-accent bg-opacity-10 mb-6">
                <HiHeart className="text-accent text-3xl" />
              </div>
              <h3 className="font-serif text-xl md:text-2xl font-bold mb-4 text-text-primary">
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-center text-text-primary mb-12">
